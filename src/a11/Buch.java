...
public class Buch extends Medium {
    ...
    public String calculateRepresentation() {
        ...
        rueckgabe.append("Titel: " + this.getTitel()).append(" ")
                .append("Erscheinungsjahr: " + this.getErscheinungsjahr()).append(" ")
                .append("Verlag: " + this.getVerlag()).append(" ")
                .append("ISBN: " + this.getIsbn()).append(" ")
